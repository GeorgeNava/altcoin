...
static const int64 nTargetTimespan = 1 * 24 * 60 * 60; // AltCoin: 1 days
static const int64 nTargetSpacing = 300; // AltCoin: 5 minute blocks
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x052a25a5c3ba18996403f9be2633a5b789fb0a8ca61bc7db2961400a038c86b0");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "October 1st 2013 5:30pm -4.5gmt";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1380664664; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 0;

        if (fTestNet)
        {
            block.nTime    = 1380664664;
            block.nNonce   = 114142;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x91b8198e64a2ac5fc725ed6e7b715d210160c7a05d40e9ddf5dc226a95dc1169"));
